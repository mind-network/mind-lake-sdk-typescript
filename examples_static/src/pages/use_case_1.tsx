...
const Index = () => {
  ...
  const { result, login, logger, loading} = useUtils();
  ...
  return (
    <div style={{display: 'flex', flexDirection: 'column'}}>
      <div><button onClick={useCase1} disabled={loading}>Test case one with your MetaMask (for development only)</button></div>
